...
// +kubebuilder:rbac:groups=management.seldon.io.seldon.io,resources=seldonclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=management.seldon.io.seldon.io,resources=seldonclusters/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=management.seldon.io.seldon.io,resources=seldonclusters/finalizers,verbs=update
